...
export default function Home() {
  ...
  return (
    <>
      ...
      <div
        className={"bg-[#4A0D00] flex justify-center items-center py-[80px]"}
      >
        <Image
          style={{ width: "560px", objectFit: "contain", maxHeight: "560px" }}
      ...
      {/*{isMobile && <div className={"pt-[120px] pb-[160px]"}>aaa</div>}*/}
